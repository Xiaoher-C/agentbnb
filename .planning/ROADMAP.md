...
Plans:
- [ ] 04-01: AgentRuntime class — DB handle ownership, SIGTERM handler, orphaned escrow recovery
- [ ] 04-02: CapabilityCard v2.0 schema — skills[] array, per-skill pricing, capacity field; SQLite migration + FTS5 trigger update
- [ ] 04-03: Gateway skill_id routing + human verification
...
| 4. Agent Runtime + Multi-Skill Foundation | v2.0 | 0/3 | Not started | - |
